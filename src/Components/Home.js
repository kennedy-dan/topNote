...
const Home = () => {
  return (
    ...
    <div className='sm:flex mx-20 justify-around my-36'>
        <div className='uyu'>
            <p className='text-center sm:text-left text-6xl xl:text-6xl sm:text-4xl md:text-4xl  font-bold lg:text-5xl   text-white '>We Help You Book Your Events </p>
